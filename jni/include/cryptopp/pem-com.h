...
// By default, keys and parameters are not validated after reading. You will have to call key.Validate()
//   yourself if desired. If you want automatic validation, then comment the line below.
...
// 64 matches OpenSSL Base64 output.
